...
int main()
{
    ...
    auto sp_d3d12_render = std::make_shared<D3D12Render>(*up_main_window);
    {
        ...
        sp_soft_render->on_render_event_guard_.Reset(up_main_window->on_rendering_, up_main_window->SetRender(sp_soft_render, [p_render](const RenderEventArgs& e)->EventState {return p_render->Rendering(e);}));
    }
