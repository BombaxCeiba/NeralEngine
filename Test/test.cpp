...
TEST(TestCaseName, TestName) {
  ...
  //EXPECT_TRUE(true);
    ...
    auto xmm_result = XMMatrixMultiply(l_matrix, r_matrix);
    ...
    bool result_m = result == target_matrix;
    auto result_vec_calcuate = target_matrix * a;
    bool b_result_vec = result_vec_calcuate == *(presult_vec);
